...
class PlaylistFragment : androidx.fragment.app.Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val playList = arrayOf("N76HNPfI4zs","XsX3ATc3FbA","mw-JgIonmD8","wksUmcAx7z4","4lKqFR-67RI","3-FXW0CW_8o","gqvEO6o1Mx8","FsEGaURjZ8w","fgja5tdRB8o")
        val playlist_title = arrayOf("[BANGTAN BOMB] JK's Heart (for ARMY♥︎) - BTS (방탄소년단)","BTS (방탄소년단) '작은 것들을 위한 시 (Boy With Luv) feat. Halsey' Official MV",
